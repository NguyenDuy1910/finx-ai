...
def load_table_schema(manager, schema_data, database):
    ...
    if entity:
        ...
        manager.map_entity_to_table(entity_name, table_name, db)
        manager.add_term(
...
def main():
    ...
    for json_file in json_files:
        ...
        table_name = load_table_schema(manager, schema_data, database)
