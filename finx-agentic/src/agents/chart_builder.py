"""Factory for the Chart Builder Agent — produces chart specs from SQL results."""
...
def create_chart_builder_agent(
    ...
    """Create a Chart Builder Agent with chart spec generation tools."""
    ...
    return Agent(
        ...
        model=create_agno_model_for_agent("chart_builder_agent"),
        description=(
